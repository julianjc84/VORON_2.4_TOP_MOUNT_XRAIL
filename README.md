Many thanks to the VzBot  and the Voron team for making these Excellent Printers.
...
# Features
 ...
 - bed printable area 336x 323y

# Requriments
 - sensorless homing
 - klicky prob (really like it so far) - need to build a gantry mount
...
- watch the videos for my journey
